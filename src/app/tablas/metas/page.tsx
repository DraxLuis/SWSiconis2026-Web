                ...
                <div className="p-4 rounded-xl border border-slate-800/60 bg-[#091122]/30 space-y-3.5 shadow-md">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      <div className="w-20 font-mono text-xs font-bold bg-[#030812] border border-slate-800/80 rounded-lg px-2.5 py-1.5 text-[#d40000] text-center">
                        {selectedMeta.finalidad_cod.slice(0, 5)}
                      </div>
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-200 truncate" title={selectedMeta.finalidad_nombre}>
                ...
                <div className="p-4 rounded-xl border border-slate-800/60 bg-[#091122]/30 space-y-3 shadow-md">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.programa_nombre}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.producto_nombre}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.actividad_nombre}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.funcion_nombre}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.division_nombre}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
                    ...
                    <div className="sm:col-span-9 flex gap-2">
                      ...
                      <div className="flex-1 text-xs font-semibold bg-[#030812] border border-slate-800/80 rounded-lg px-3 py-1.5 text-slate-300 truncate" title={selectedMeta.grupo_nombre}>
