...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#020B18] text-white font-sans overflow-hidden relative selection:bg-[#D40000]/30 selection:text-white">
      ...
      {/* ========================================== */}
      <div 
        className="hidden lg:flex lg:w-[52%] xl:w-[58%] flex-col justify-between p-12 relative border-r border-white/[0.04] overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="z-10 max-w-2xl my-auto space-y-8 stagger-children">
        ...
        {/* Footer Inferior */}
        <div className="flex items-center justify-between z-10 text-[10px] text-[#4A6080] font-semibold tracking-wide border-t border-white/[0.04] pt-6 animate-fade-in">
      ...
      {/* ========================================== */}
      <div 
        className="w-full lg:w-[48%] xl:w-[42%] flex flex-col justify-between p-8 md:p-12 relative bg-[#020B18]"
      >
        ...
        {/* Logo superior en móviles únicamente */}
        <div className="flex lg:hidden items-center gap-3 mb-8 animate-fade-in">
          <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-[#D40000] to-[#8B0000] flex items-center justify-center">
            <span className="text-xs font-black text-white tracking-widest">SC</span>
          </div>
          <div>
            <div className="flex items-baseline gap-1 leading-none">
              <span className="text-sm font-black tracking-widest text-white">SICONIS</span>
              <span className="text-[10px] font-bold text-[#D40000]">2026</span>
            </div>
            <p className="text-[8px] text-[#4A6080] font-bold tracking-widest uppercase mt-0.5">
              Consultas Interactivas SIAF®
            </p>
          </div>
        </div>
        ...
        {/* Formulario centrado */}
        <div className="my-auto w-full max-w-[400px] mx-auto z-10">
        ...
        {/* Footer en derecho: estado de red / servidores */}
        <div className="flex items-center justify-between border-t border-white/[0.04] pt-6 text-[9px] font-bold tracking-wider text-slate-500 z-10">
