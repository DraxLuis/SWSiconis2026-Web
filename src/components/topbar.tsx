  ...
  return (
    <header className="topbar">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* User chip */}
        <button className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.07] hover:border-white/10 transition-all duration-200 group">
