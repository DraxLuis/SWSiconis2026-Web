...
router.get('/', async (req: Request, res: Response) => {
  try {
    const type = req.query.type as string | undefined; // gasto_1, gasto_2, gasto_3, ingreso_1, ingreso_2, ingreso_3, certificados, multianual
    const rubro = req.query.rubro as string | undefined;
    const meta = req.query.meta as string | undefined;
    ...
    console.error('Error in reportes route:', error);
